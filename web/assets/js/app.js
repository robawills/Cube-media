...
var _headerbg = __webpack_require__(41);

var _headerbg2 = _interopRequireDefault(_headerbg);

var _projectScroll = __webpack_require__(43);

var _projectScroll2 = _interopRequireDefault(_projectScroll);
...
(0, _jquery2.default)(function () {
    (0, _headerbg2.default)();
});

(0, _jquery2.default)(function () {
    (0, _projectScroll2.default)();
});
...
var chatBox = function chatBox() {
    var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.chat';


    (0, _jquery2.default)(selector).click(function () {
        (0, _jquery2.default)(this).addClass('chat--open');
    });
    (0, _jquery2.default)(document).on('click', '.chat__close', function () {
        (0, _jquery2.default)(selector).removeClass('chat--open');
    });
};
...
var form = function form() {
  var form = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.js-contact-form';
  return (0, _jquery2.default)(form).submit(_sendForm);
};

// Private: Send form event
var _sendForm = function _sendForm(event) {
  var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : event.currentTarget;
  ...
  _jquery2.default.ajax({
    ...
    return data.success == true ? _formSuccess(data, form) : _formFailure(data, form);
  });
};

// Private: Form failure
var _formFailure = function _formFailure(data, form) {
  ...
  var validationMsgSelectors = form.querySelectorAll(_globals.validationMsgSelector);
  validationMsgSelectors.forEach(function (validationMsgSelector) {
    return validationMsgSelector.remove();
  });
  ...
  Object.keys(data.errors).forEach(function (key) {
    ...
    var fieldLabel = field.querySelector(_globals.labelSelector) ? field.querySelector(_globals.labelSelector) : field;
...
var _formSuccess = function _formSuccess(data, form) {
...
var headerbg = function headerbg() {
    var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.header--light';
    ...
    (0, _jquery2.default)(window).scroll(function () {
        ...
        if (scroll >= 300) {
            (0, _jquery2.default)(selector).addClass("header--dark");
        } else {
            (0, _jquery2.default)(selector).removeClass("header--dark");
        }
    });
};
...
var menu = function menu() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.hamburger';


  (0, _jquery2.default)(selector).click(function () {
    (0, _jquery2.default)(this).toggleClass('menu-open');
  });

  (0, _jquery2.default)('.js-off-canvas-overlay').click(function () {
    (0, _jquery2.default)(selector).removeClass('menu-open');
  });
};
...
var projectscroll = function projectscroll() {
    ...
    (0, _jquery2.default)(document).ready(function () {
        ...
        function calcScrollPerc() {
            var posY = (0, _jquery2.default)(window).scrollTop(),
                posH = (0, _jquery2.default)(document).height(),
                scrollH = (0, _jquery2.default)(window).height(),
        ...
        function parralaxAnimation() {
            var perc = calcScrollPerc(),
                colLH = (0, _jquery2.default)('#col-left').height(),
                colRH = (0, _jquery2.default)('#col-right').height(),
            ...
            if (mobile === false) {
                ...
                if (colLH > colRH) {
                    // right colum smaller
                    (0, _jquery2.default)('#col-right').css({ 'transform': 'translateY(+' + diffH + 'px)' });
                } else if (colRH > colLH) {
                    // left colum smaller
                    (0, _jquery2.default)('#col-left').css({ 'transform': 'translateY(+' + diffH + 'px)' });
                }
            } else {
                // restore original position on mobile
                (0, _jquery2.default)('#col-right').css({ 'transform': 'translateY(0)' });
                (0, _jquery2.default)('#col-left').css({ 'transform': 'translateY(0)' });
            }
        }
        ...
        // on scroll / resize
        (0, _jquery2.default)(window).on('resize scroll', function () {
            parralaxAnimation();
            // to the top icon
            // $('#tothetop').initCanvas();
        });
